...
use crate::entities::{AggregateResult, PageResult, Tag, TagAggregateSearch, TagListSearch};
...
impl TagRepository {
    ...
    pub async fn search_all(
        ...
        let query = tag_query::select_all_with_query(user_id, search)?;
    ...
    pub async fn aggregate_all(
        ...
        let query = tag_query::aggregate_all_with_query(user_id, search)?;
