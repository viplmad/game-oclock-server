use sea_query::{Expr, ExprTrait, Query, QueryStatementWriter, SelectStatement, SimpleExpr};
use uuid::Uuid;

use crate::entities::{
    AggregateQuery, SearchQuery, Tag, TagAggregateSearch, TagIden, TagListSearch,
};
...
pub fn aggregate_all_with_query(
    user_id: &Uuid,
