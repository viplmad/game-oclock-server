...
pub async fn search_first_by_date_between(
    ...
    let search_query =
    dlc_finish_query::select_first_dlc_with_finish_with_search_by_date_gte_and_date_lte_order_by_date_asc(
...
pub async fn search_last_by_date_between(
    ...
    let search_query =
        dlc_finish_query::select_last_dlc_with_finish_with_search_by_date_gte_and_date_lte_order_by_date_desc(
            user_id, start_date, end_date, search,
        )?;
    fetch_all_search(pool, search_query).await
}
