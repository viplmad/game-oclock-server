...
use crate::entities::{AggregateResult, PageResult, User, UserAggregateSearch, UserListSearch};
...
impl UserRepository {
    ...
    pub async fn search_all(
        ...
        let query = user_query::select_all_with_search(search)?;
    ...
    pub async fn aggregate_all(
        ...
        let query = user_query::aggregate_all_with_search(search)?;
