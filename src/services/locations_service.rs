...
pub async fn get_location(
    ...
    let find_result = repository.find_by_id(user_id, location_id).await;
...
pub async fn create_location(
    ...
    create_merged(
        location,
        async move |created_location_id| {
            get_location(repository, user_id, &created_location_id).await
        },
        async move |mut location_to_create: Location| {
            ...
            let create_result = repository.create(&location_to_create).await;
...
pub async fn update_location(
    ...
    update_merged(
        location,
        async move || get_location(repository, user_id, location_id).await,
        async move |mut location_to_update: Location| {
            ...
            let update_result = repository.update(&location_to_update).await;
...
pub async fn delete_location(
    ...
    let delete_result = repository.delete_by_id(user_id, location_id).await;
...
pub async fn exists_location(
    ...
    let exists_result = repository.exists_by_id(user_id, location_id).await;
