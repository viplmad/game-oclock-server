...
impl GenreService {
    pub async fn get_genre(&self, user_id: &str, genre_id: &str) -> Result<GenreDTO, ApiErrors> {
        let find_result = self.repository.find_by_id(user_id, genre_id).await;
    ...
    pub async fn create_genre(
        ...
        create_merged(
            genre,
            async move |created_genre_id| self.get_genre(user_id, &created_genre_id).await,
            async move |genre_to_create| {
                ...
                let create_result = self.repository.create(user_id, &genre_to_create).await;
    ...
    pub async fn update_genre(
        ...
        update_merged(
            genre,
            async move || self.get_genre(user_id, genre_id).await,
    ...
    pub async fn delete_genre(&self, user_id: &str, genre_id: &str) -> Result<(), ApiErrors> {
        let delete_result = self.repository.delete_by_id(user_id, genre_id).await;
        handle_action_result::<GenreDTO>(delete_result)
    }

    pub async fn exists_genre(&self, user_id: &str, genre_id: &str) -> Result<(), ApiErrors> {
        let exists_result = self.repository.exists_by_id(user_id, genre_id).await;
