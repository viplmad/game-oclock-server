...
pub fn get_openapi() -> utoipa::openapi::OpenApi {
    ...
    #[openapi(
        ...
        paths(
            ...
            routes::get_total_media_sessions,
            routes::get_session_medias_review,
        ...
        components(schemas(
            ...
            models::MediasReviewDTO,
            models::MediaReviewDTO,
            models::MediaIdsStreakDTO,
            models::MediaIdSessionDTO,
            models::MediaStatus,
