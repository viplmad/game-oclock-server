...
pub fn get_openapi() -> utoipa::openapi::OpenApi {
    ...
    #[openapi(
        ...
        paths(
            ...
            routes::aggregate_tag_medias,
            routes::get_location_medias,
            routes::aggregate_location_medias,
            routes::get_device_medias,
            routes::aggregate_device_medias,
            routes::get_medias,
            routes::aggregate_medias,
            routes::create_media,
            routes::update_media,
            ...
            routes::aggregate_media_tags,
            routes::get_tags,
            routes::aggregate_tags,
            routes::create_tag,
            routes::update_tag,
            routes::delete_tag,
            // Locations
            ...
            routes::aggregate_media_locations,
            routes::get_locations,
            routes::aggregate_locations,
            ...
            routes::aggregate_media_devices,
            routes::get_devices,
            routes::aggregate_devices,
        ...
        components(schemas(
            ...
            models::AggregateMetricDTO,
            models::AggregateMetricType,
